            ...
            if ((strcmp(command, "cd", 2)) && (buffer[i] != '\0')) {
                ...
                if ((i - off == 0)) {
                    ...
                    if (succ) {
                        ...
                        curdir = dest;
                        interrupt(0x21, 0x0, "Anda telah ke direktori : ", 0, 0);
                        interrupt(0x21, 0x0, arguments, 0, 0);
                        interrupt(0x21, 0x0, "\n", 0, 0);
                    } else {
                        interrupt(0x21, 0x0, "Directori tidak ditemukan : ", 0, 0);
                        interrupt(0x21, 0x0, arguments, 0, 0);
                        interrupt(0x21, 0x0, "\n", 0, 0);
                    }
                }
